...
/* Releases the args data of the current (exiting) process,
  closes files, cleans up what is left of the PTCB list of the exiting process, 
  disconnects main_thread and marks current process as exited.
*/
